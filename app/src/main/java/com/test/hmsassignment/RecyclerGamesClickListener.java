...
public class RecyclerGamesClickListener extends RecyclerView.SimpleOnItemTouchListener {
    OnItemClickListener clickListener;
    GestureDetectorCompat gestureDetector;

    public RecyclerGamesClickListener(RecyclerView recyclerView, OnItemClickListener listener) {
